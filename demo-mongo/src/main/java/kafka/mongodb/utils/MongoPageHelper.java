...
import kafka.mongodb.entry.PageResult;
...
/**
 * Created by pengxingxiong@ruijie.com.cn on 2019/1/11 19:56
...
public class MongoPageHelper {
    ...
    /**
     * 分页查询，不考虑条件分页，直接使用skip-limit来分页.分页查询，直接返回集合类型的结果.
     */
     ...
     */
    private <T, R> PageResult<R> pageQuery(Query query, Class<T> entityClass,
